...
class Reporte extends GenReporte
{
	...
	function Cabecera(){
		...
		$this->Cell(18,$this->lineHeight,'FECHA',1,0,'C',1);		
                ...
                $this->Cell(90,$this->lineHeight,'DEPENDENCIA',1,0,'C',1);
	...
	function Detalle(){
		global $rs;	
		$this->printField(dtos($rs->field("pero_fecha")), 'C1','items',0,'C');                
                $this->printField($rs->field("pero_documento"), 'C2','items',0,'L');
                $this->printField($rs->field("dependencia"), 'C3','items',0,'L',true);
...
/*	recibo los parametros */
	...
	$_titulo = "ROTACIONES" ; // T?tulo del reporte
