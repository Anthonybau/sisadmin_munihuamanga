...
class Reporte extends GenReporte
{
	...
	function Cabecera(){
		...
		$this->Cell(20,$this->lineHeight+1,'FECHA',1,0,'C',1);		
                $this->Cell(50,$this->lineHeight+1,'ENTIDAD BANCARIA',1,0,'C',1);		
                $this->Cell(40,$this->lineHeight+1,'CUENTA',1,0,'C',1);		
	...
	function Detalle(){
		global $rs;	
		$this->printField(dtos($rs->field("pecb_fecha")), 'C1','items',0,'L');		
                $this->printField($rs->field("banco"), 'C2','items',0,'L');		
                $this->printField($rs->field("pecb_cuentadeposito"), 'C3','items',0,'L');
...
/*	recibo los parametros */
	...
	$_titulo = "REGISTRO DE CUENTAS BANCARIAS" ; // T?tulo del reporte
