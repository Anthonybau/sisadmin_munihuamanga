...
var FacebookList = new Class({
  ...
  removeAllBox: function() {
      var bits=this.bits.getKeys();//obtengo los nombres de los li's del obtejo
      for(x=0;x<bits.length;x++){
        this.dispose(document.getElementById(bits[x])); //con nombre del li, lo transformo en objeto con el getElement.
      }
      return this;
  },
