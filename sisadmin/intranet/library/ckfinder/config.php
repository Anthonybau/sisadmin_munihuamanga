<?php
/*SE INICIA PARA CONTROLAR LAS CARPETAS*/
...
$config['authentication'] = function () {
    return isset($_SESSION['sis_userid']) && $_SESSION['sis_userid'];
};
...
//$config['licenseKey']  = 'EF8FK33K7PFBF83FSQ4W4WLYSJWD9';

$config['licenseName'] = trim($_SERVER['SERVER_NAME']);

switch (trim($_SERVER['SERVER_NAME'])){    
    case 'qlmedic.mytienda.net':
        $config['licenseKey']  = 'DYTYN3YRMGTG1NRNJD23ELSS9JHDM';
        break;
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => '/docs/'.$_SESSION['sis_empresa_ruc'].'/ckfinder_'.$_SESSION['sis_userid'].'/',    
