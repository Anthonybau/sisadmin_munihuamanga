...
this.btnList = {
    ...
    "justifyleft":    ['JustifyLeft',          'Alinhar a Esquerda', 'editor_action(this.id)',  'ed_align_left.gif'],
    "justifycenter":  ['JustifyCenter',        'Centralizar',        'editor_action(this.id)',  'ed_align_center.gif'],
    "justifyright":   ['JustifyRight',         'Alinhar a Direita',  'editor_action(this.id)',  'ed_align_right.gif'],
    "orderedlist":    ['InsertOrderedList',    'Lista Ordenada',     'editor_action(this.id)',  'ed_list_num.gif'],
    "unorderedlist":  ['InsertUnorderedList',  'Lista',              'editor_action(this.id)',  'ed_list_bullet.gif'],
    "outdent":        ['Outdent',              'Identar a Esquerda', 'editor_action(this.id)',  'ed_indent_less.gif'],
    "indent":         ['Indent',               'Identar a Direita',  'editor_action(this.id)',  'ed_indent_more.gif'],
    "forecolor":      ['ForeColor',            'Cor da Fonte',       'editor_action(this.id)',  'ed_color_fg.gif'],
    "backcolor":      ['BackColor',            'Cor do Fundo',       'editor_action(this.id)',  'ed_color_bg.gif'],
