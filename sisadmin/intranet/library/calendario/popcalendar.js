...
Calendar._TT = {};
Calendar._TT["TOGGLE"] = "Selecionar primer dia de la semana";
Calendar._TT["PREV_YEAR"] = "Año anterior (seguir para menu)";
Calendar._TT["PREV_MONTH"] = "Mes anterior (seguir para menu)";
Calendar._TT["GO_TODAY"] = "Hoy día";
Calendar._TT["NEXT_MONTH"] = "Próximo mes (seguir para menu)";
Calendar._TT["NEXT_YEAR"] = "Próximo año (seguir para menu)";
Calendar._TT["SEL_DATE"] = "Selecione Fecha";
